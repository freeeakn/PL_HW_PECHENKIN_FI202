 ...
 *
 * This function reads the grid size, the grid itself, the start and end
 * positions, and the maximum turns. It then calls the bfs function to find the
 * minimum time required for the robot to reach the end position.
 *
...
int main() {
  ...
  int startX, startY, endX,
      endY; // Variables to store the start and end positions
  ...
  // Call the bfs function to find the minimum time required to reach the end
  // position
